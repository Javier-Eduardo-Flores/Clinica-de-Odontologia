...
import { LayoutDashboard, Calendar, User, Users, Package, Receipt, Settings, HelpCircle, LogOut, ClipboardList } from "lucide-react";
...
const menuItems = [
    ...
    { label: "Expediente", icon: ClipboardList, href: "/dashboard/expediente" },
...
return (
    <aside className="w-64 h-screen bg-white border-r border-gray-200 flex flex-col sticky top-0">
        ...
        <div>
            <p className="font-sans font-bold text-clinica-dark leading-tight">ClinicaDental</p>
