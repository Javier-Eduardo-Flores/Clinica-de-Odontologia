...
import EditarOdontologoForm from "@/app/components/odontologos/EditarOdontologoForm";

export default async function EditarOdontologoPage({
  params,
}: {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-5">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <EditarOdontologoForm odontologo={odontologo} />
        </div>
      </div>
    </div>
  );
