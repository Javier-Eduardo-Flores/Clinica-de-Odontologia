...
import { eliminarEspecialidad } from "@/app/actions/especialidades";
import ConfirmDialog from "@/app/components/confirmdialog";

export default function EliminarEspecialidadPage({
  params,
}: {
