...
import RecepcionistaForm from "@/app/components/personal/RecepcionistaForm";

export default async function NuevoRecepcionistaPage() {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8">
          ...
          <p className="text-center text-gray-500 font-sans text-sm mb-6">
            Completa los datos para registrar una nueva recepcionista.
          </p>
